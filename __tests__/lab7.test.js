describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const buttoneHandle = await shadowRoot.$('button');

    await buttoneHandle.click();
    const buttoneText = await buttoneHandle.getProperty('innerText');
    const value = await buttoneText.jsonValue();
